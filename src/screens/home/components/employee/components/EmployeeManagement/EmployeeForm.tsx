...
import { updateMarkToDelete } from "../../../../../../services/home/updateMarkToDelete";
      ...
      <div className="relative bg-white rounded-lg p-4 mt-4 shadow-sm overflow-auto">
        ...
        <div className=" text-sm rounded-2xl h-[600px] bg-[#FBFCFD] my-2 overflow-x-scroll">
          <div
            ...
            className="absolute inset-0 bg-black/[.1] flex z-10 "
          >
                  ...
                  <td>
                    {listMarkedDelete.includes(it.id) ? (
                      <div className="text-center mt-2">
                        <FontAwesomeIcon
                          className="text-green-600 mx-auto h-5"
                          icon={faCheckSquare}
                        />
                      </div>
                    ) : (
        ...
        <div className="flex gap-1 mt-4">
            ...
            <div className="flex gap-1">
              <button
                ...
                className={`px-3 py-2 bg-[#F1F3F5] ${
                  1 == table.current_page ? "brightness-75" : ""
                } rounded-lg`}
              >
                1
              </button>
              ...
              {table.last_page - 2 > 1 && (
                <button
                  ...
                  className={`px-3 py-2 bg-[#F1F3F5] ${
                    table.last_page - 2 == table.current_page
                      ? "brightness-75"
                      : ""
                  } rounded-lg`}
                >
              ...
              {table.last_page - 1 > 1 && (
                <button
                  ...
                  className={`px-3 py-2 bg-[#F1F3F5] ${
                    table.last_page - 1 == table.current_page
                      ? "brightness-75"
                      : ""
                  } rounded-lg`}
                >
          ...
          {table.current_page + 2 < table.last_page && (
            <div className="flex gap-1">
              <button
                className={`px-3 py-2 bg-[#F1F3F5] brightness-75 rounded-lg`}
              >
                {table.current_page}
              </button>
              <button
              ...
              {table.current_page + 3 < table.last_page && (
          ...
          <div className="px-3 py-2 bg-[#F1F3F5] rounded-lg">
